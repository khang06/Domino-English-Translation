...
echo "BUILD_DATE_TIDY=$(date +'%Y/%m/%d')" >> $GITHUB_OUTPUT
...
echo "Building 1.43 (nightly version)..."
...
cat >temp/compile-config.json <<EOL
{
	...
	"fullVersion": "1.43-en.$VERSION_NUM-nightly.$BUILD_DATE",
...
echo "Building 1.45 dev006 (32-bit) (nightly version)..."
...
cat >temp/compile-config.json <<EOL
{
	...
	"fullVersion": "1.45 dev006-en.$VERSION_NUM-nightly.$BUILD_DATE",
	"buildVersion": "$VERSION_NUM-nightly.$BUILD_DATE",
	"executableName": "Domino.exe",
	"compilePath": "temp/_compile",
	"supplyTranslationReadme": "true",
...
echo "Packing distributable..."
cd temp/_compile/
7z a ../../dist/Domino145_dev006_x86_Translated.zip *
cd ../../
mv -v temp/_compile/Domino.exe dist/Domino145_dev006_x86_Translated.exe
echo "Packing done!"
# End of packing
echo "::endgroup::"
...
echo "Building 1.45 dev006 (64-bit) (nightly version)..."
...
echo "Packing distributable..."
cd temp/_compile/
7z a ../../dist/Domino145_dev006_x64_Translated.zip *
cd ../../
mv -v temp/_compile/Domino.exe dist/Domino145_dev006_x64_Translated.exe
echo "Packing done!"
# End of packing
echo "::endgroup::"
