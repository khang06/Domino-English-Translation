...
cat >temp/compile-config.json <<EOL
{
	...
	"fullVersion": "1.44-en.$VERSION_NUM-artifact.$BUILD_DATE",
	"buildVersion": "$VERSION_NUM-artifact.$BUILD_DATE",
	"executableName": "Domino.exe",
	"compilePath": "temp/_compile",
	"supplyTranslationReadme": "true",
...
echo "Building 1.45 dev006 (32-bit) (artifact/push check version)..."
...
cat >temp/compile-config.json <<EOL
{
	...
	"fullVersion": "1.45 dev006-en.$VERSION_NUM-artifact.$BUILD_DATE",
	"buildVersion": "$VERSION_NUM-artifact.$BUILD_DATE",
	"executableName": "Domino.exe",
	"compilePath": "temp/_compile",
	"supplyTranslationReadme": "true",
...
cd temp/_compile/
cd ../../
cp -rv temp/_compile/ dist/Domino145_dev006_x86_Translated
echo "Packing done!"
# End of packing
echo "::endgroup::"
...
echo "Building 1.45 dev006 (64-bit) (artifact/push check version)..."
...
cd temp/_compile/
cd ../../
cp -rv temp/_compile/ dist/Domino145_dev006_x64_Translated
echo "Packing done!"
# End of packing
echo "::endgroup::"
